...
# We have worked out they are using one the passwords
...
with ZipFile("/tmp/alien-sample-42.zip", "r") as z:
  for line in possiblePasswordList:
    try:
      z.extractall("/tmp", pwd = bytes(str(line), "UTF-8"))
